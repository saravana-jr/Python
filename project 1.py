...
class Feedback:
    ...
    def __init__(self, master):
        ...
        self.style.configure("TLabel",background="yellow")
        ...
        self.logo = PhotoImage(file="C:\\Users\\Ganesh\\Downloads\\pubg_PNG54.png").subsample(10,10)
        ttk.Label(self.frame_header,image=self.logo).grid(row=0,column=0,rowspan=2)
        ttk.Label(self.frame_header,text="Thanks for Playing Pubg",style="Header.TLabel").grid(row=0,column=1)
        ttk.Label(self.frame_header,text="Give Feedback about our game").grid(row=1,column=1)
    ...
    def submit(self):
        ...
        self.clear()
        messagebox.showinfo(title="Pubg Feedback",message="comments submitted")
